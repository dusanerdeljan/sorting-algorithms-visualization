...
{
private:
	void Reverse(std::vector<int>& numbers, int n, std::vector<Animation>& animations) const;
	int FindMaxIndex(std::vector<int>& numbers, int n, std::vector<Animation>& animations) const;
public:
